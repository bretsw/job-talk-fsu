...
--
  ...
  - so I built an R software package: **tidytags**
...
- **Significance:** Makes big data, digital trace methods more accessible to a broader range of social scientists (reducing bias)
...
I will design **tools** to support researchers and designers of networked learning.

--

- R packages (e.g., to aid Reddit data collection and analysis)

--

- Web apps (e.g., for categorizing online communities on Twitter and Reddit)
...
I will design **tools** to support networked learning researchers and designers.

These tools should be of interest to funding agencies:

--

- Russell Sage Foundation call for Computational Social Science

--

- Alfred P. Sloan Foundation call for Data & Computational Research

---

# Networked learning literacies

```{r, out.width = "480px", echo = FALSE, fig.align = "center"}
include_graphics("img/transition.jpg")
```

I will design **networked learning literacies** for practitioners.

--

- Recommendations for using social media to pursue the *possibilities* of networked learning and avoid the *perils*

--

- Guidelines for emergency response (e.g., pandemic, natural disaster)

--

- Guidelines for job transitions (e.g., new teachers, new faculty, promotions)
...
My research will aid the design of **equitable communities**.
...
My research will aid the design of:

tools, networked learning literacies, and equitable communities
